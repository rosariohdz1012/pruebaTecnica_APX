...
/**
 * Test for transaction WIKJT44401MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT44401MXTest.xml" })
public class WIKJT44401MXTransactionTest {

	@Autowired
	private WIKJT44401MXTransaction transaction;
